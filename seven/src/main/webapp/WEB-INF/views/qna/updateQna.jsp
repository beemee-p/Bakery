...
<div class="container QnAwrite">	
	...
	<form:form method="post" action="QnaUpdate.do" id="QnAUpdateForm" enctype="multipart/form-data" commandName="qna">		
		<input type="hidden" name="qNum" id="qNum"  readonly="readonly" value="${qna.qNum}"/>		
		...
		<div class="table_area">
			<table class="QnAwrite_table">
				...
				<tr>
					<th scope="row">제목</th>
					<td><input type="text" name="qTitle" id="qTitle" value="${qna.qTitle }" readonly="readonly" class ="rows"/></td>				
				</tr>
				<tr>
					<th scope="row">내용입력</th>
					<td><textarea rows="5" cols="60" name="qContent" id="qContent" class ="rows" >${qna.qContent }</textarea></td>
				</tr>
				<tr>
					<th scope="row">첨부파일</th>
					<td><input type="file" name="qFile" id="qFile" class ="rows" value="${qna.qFile }"></td>
				</tr>						
			</table>	
			<span id="buttons">
				<button type="button" id="btn_write" onclick='checkupdateQnA()'>수정</button>
